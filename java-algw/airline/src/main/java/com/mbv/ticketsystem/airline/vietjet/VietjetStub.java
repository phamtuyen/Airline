...
public class VietjetStub {
	...
	private boolean detailBookVietJet(AirItinerary itinerary,long sumPrices) throws Exception{
		...
		// Compare prices
		logger.info("vietjetDetail Compare prices: " + sumPrices);
	...
	public BookResult bookVietJet(AirItinerary itinerary,long sumPrices) throws Exception {
		try {		
			//System.out.println("VietjetBook:Login");
			logger.info("VietjetBook:Login");
			loginBookVietJet();
			//System.out.println("VietjetBook:menu");	
			logger.info("VietjetBook:menu");
			menuBookVietJet();
			//System.out.println("VietjetBook:search");
			logger.info("VietjetBook:search");
			searchBookVietJet(itinerary);	
			logger.info("VietjetBook:travel");
			//System.out.println("VietjetBook:travel");
			travelBookVietJet(itinerary);
			logger.info("VietjetBook:detail");
			//System.out.println("VietjetBook:detail");
			...
			//System.out.println("VietjetBook:addons");
			logger.info("VietjetBook:addons");
			addonsBookVietJet(itinerary);	
			logger.info("VietjetBook:payment");
			System.out.println("VietjetBook:payment");
			paymentsBookVietJet();
			// lock
			//			confirmBookVietJet();
			//			return itineraryBookVietJet();		
			// Begin TEST
			logger.info("VietjetBook:begin result");
			//System.out.println("VietjetBook:begin result");
			...
			if (!urlResult.toString().contains("Confirm.aspx"))
				...
				//System.out.println("VietjetBook:result");
				logger.info("VietjetBook:result");
				String amountBook = document.select("#rescharges > tbody > tr.ChargesTotal > td:nth-child(2) > strong").text();
				long sumAmount = Long.valueOf(amountBook.replace(",", "")).longValue(); 				
				result = new BookResult();	
	...
	private void searchResOneBuyVietJet(AirItinerary itinerary) throws Exception{
		...
		//final String reservationCode = "18043515";
	...
	public BuyResult buyVietJet(AirItinerary itinerary) throws Exception {	
		try {		
			logger.info("VietjetPayMent:login");
			loginBuyVietJet();
			logger.info("VietjetPayMent:menu");
			menuBuyVietJet();
			logger.info("VietjetPayMent:search1");
			searchResOneBuyVietJet(itinerary);
			logger.info("VietjetPayMent:search2");
			searchResTwoBuyVietJet(itinerary);
			logger.info("VietjetPayMent:recindFucnc");
